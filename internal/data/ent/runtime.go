...
func init() {
	...
	menuDescHideInMenu := menuFields[21].Descriptor()
	...
	menuDescHideInTab := menuFields[22].Descriptor()
	...
	menuDescHideInBreadcrumb := menuFields[23].Descriptor()
	...
	menuDescHideChildrenInMenu := menuFields[24].Descriptor()
