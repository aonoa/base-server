...
var (
	...
	MenusColumns = []*schema.Column{
		...
		{Name: "sort", Type: field.TypeInt8, Unique: true, Comment: "排序(越小越前)"},
		...
		{Name: "isext", Type: field.TypeBool, Comment: "外链,0-否，1-是"},
		{Name: "isshow", Type: field.TypeBool, Comment: "显示,0-否，1-是"},
		{Name: "keepalive", Type: field.TypeBool, Comment: "缓存,0-否，1-是"},
		{Name: "affix", Type: field.TypeBool, Comment: "固钉,0-否，1-是"},
		{Name: "ignore_auth", Type: field.TypeBool, Comment: "忽略权限,0-否，1-是"},
		{Name: "breadcrumb", Type: field.TypeBool, Comment: "显示在面包屑,0-否，1-是"},
	}
