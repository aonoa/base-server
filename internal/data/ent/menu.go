	...
	for i := range columns {
		...
		case menu.FieldMenuVisibleWithForbidden:
			if value, ok := values[i].(*sql.NullBool); !ok {
				...
				_m.MenuVisibleWithForbidden = value.Bool
			}
		case menu.FieldLink:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case menu.FieldMaxNumOfOpenTab:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.MaxNumOfOpenTab = int16(value.Int64)
			}
		...
		case menu.FieldAffixTabOrder:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.AffixTabOrder = int16(value.Int64)
			}
...
func (_m *Menu) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.FullPathKey))
	builder.WriteString(", ")
