...
func (_q *ResourceQuery) QueryRoles() *RoleQuery {
...
func (_q *ResourceQuery) WithRoles(opts ...func(*RoleQuery)) *ResourceQuery {
	query := (&RoleClient{config: _q.config}).Query()
...
func (_q *ResourceQuery) loadRoles(ctx context.Context, query *RoleQuery, nodes []*Resource, init func(*Resource), assign func(*Resource, *Role)) error {
