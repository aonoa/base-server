...
//		GroupBy(userrolebinding.FieldCreateTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.UserRoleBinding.Query().
//		Select(userrolebinding.FieldCreateTime).
//		Scan(ctx, &v)
...
func (_q *UserRoleBindingQuery) Modify(modifiers ...func(s *sql.Selector)) *UserRoleBindingSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *UserRoleBindingSelect) Modify(modifiers ...func(s *sql.Selector)) *UserRoleBindingSelect {
