...
func (_u *UserUpdate) AddDeptIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddDeptIDs(ids...)
	return _u
}

// AddDept adds the "dept" edges to the Dept entity.
func (_u *UserUpdate) AddDept(v ...*Dept) *UserUpdate {
...
func (_u *UserUpdate) RemoveDeptIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveDeptIDs(ids...)
	return _u
}

// RemoveDept removes "dept" edges to Dept entities.
func (_u *UserUpdate) RemoveDept(v ...*Dept) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddDeptIDs adds the "dept" edge to the Dept entity by IDs.
func (_u *UserUpdateOne) AddDeptIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddDeptIDs(ids...)
	return _u
}

// AddDept adds the "dept" edges to the Dept entity.
func (_u *UserUpdateOne) AddDept(v ...*Dept) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveDeptIDs removes the "dept" edge to Dept entities by IDs.
func (_u *UserUpdateOne) RemoveDeptIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveDeptIDs(ids...)
	return _u
}

// RemoveDept removes "dept" edges to Dept entities.
func (_u *UserUpdateOne) RemoveDept(v ...*Dept) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
